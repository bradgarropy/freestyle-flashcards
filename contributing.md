...
```bash
git clone https://github.com/<username>/freestyle-flashcards
```

Next you need to install the dependencies.

```bash
cd freestyle-flashcards
npm install
```
...
[issues]: https://github.com/bradgarropy/freestyle-flashcards/issues
[codesandbox]: https://codesandbox.io
[kcd-pr]: https://egghead.io/courses/how-to-contribute-to-an-open-source-project-on-github
[license]: https://github.com/bradgarropy/freestyle-flashcards/blob/master/license
[fork]: https://github.com/bradgarropy/freestyle-flashcards/fork
[contributors]: https://github.com/bradgarropy/freestyle-flashcards#-contributors
